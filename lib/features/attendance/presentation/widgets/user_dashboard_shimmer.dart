...
class UserDashboardShimmer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      label: 'attendance.loading_dashboard'.tr(),
      child: Scaffold(
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      verticalSpace(12.h),
                      _buildAttendanceStatsCard(isSmallScreen,context),
                      verticalSpace(20.h),
                    ],
                  ),
                ),
  ...
  Widget _buildAttendanceStatsCard(bool isSmallScreen,BuildContext context) {
    return Shimmer(
      duration: const Duration(seconds: 3),
      color: Colors.grey[100]!,
      colorOpacity: 0.3,
