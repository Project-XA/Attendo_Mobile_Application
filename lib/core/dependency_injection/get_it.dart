...
Future<void> initCore() async {
  ...
  // Hive - Student
  final studentBox = await Hive.openBox<StudentModelHive>('students');
  getIt.registerLazySingleton<Box<StudentModelHive>>(() => studentBox);
  ...
  getIt.registerLazySingleton<StudentLocalDataSource>(
    () => StudentLocalDataSourceImp(studentBox: getIt()),
  );
